...
## [1.0.6] - 2021-10-28
### Added
- Background color change on hover on "fonctionnement items".
...
## [1.0.3] - 2021-10-21
### Added
- mailto link on menu pages.
- Aditional comments.

### Fixed
- Blurry text on growing items (restaurants cards and fonctionnement items).
- Overlapping of the price on hover animation (menu pages).
...
## [1.0.2] - 2021-10-20
### Fixed
- W3C error in index file (The element label must not appear as a descendant of the a element).
